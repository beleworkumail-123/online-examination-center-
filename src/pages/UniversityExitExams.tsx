  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-2 py-2 pt-1">
        ...
        <Breadcrumb className="mb-8 pt-7 pb-2">
          <BreadcrumbList>
            <BreadcrumbItem>
              <BreadcrumbLink 
                onClick={() => navigate('/')} 
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Exit Exams</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-foreground mb-4">University Exit Exams</h1>
...
export default UniversityExitExams;