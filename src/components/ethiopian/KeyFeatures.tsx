    ...
    <section className="py-16 md:py-24 bg-gradient-to-b from-background to-secondary/20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            return (
              ...
              >
                <CardContent className="p-8 text-center">
                  {/* Icon */}
                  <div className={`w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br ${feature.bgGradient} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div className="group">
            <div className="bg-gradient-to-br from-success/10 to-success/5 rounded-xl p-6 mb-4 group-hover:scale-105 transition-transform">
              <Lock className="h-8 w-8 text-success mx-auto mb-2" />
              <div className="font-bold text-lg text-foreground">256-bit</div>
              <div className="text-sm text-muted-foreground">SSL Encryption</div>
            </div>
          </div>
          
          <div className="group">
            <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-xl p-6 mb-4 group-hover:scale-105 transition-transform">
          ...
          <div className="group">
            <div className="bg-gradient-to-br from-warning/10 to-warning/5 rounded-xl p-6 mb-4 group-hover:scale-105 transition-transform">
              <Zap className="h-8 w-8 text-warning mx-auto mb-2" />
              <div className="font-bold text-lg text-foreground">&lt;2s</div>
              <div className="text-sm text-muted-foreground">Load Time</div>
            </div>
          </div>
          
          <div className="group">
            <div className="bg-gradient-to-br from-destructive/10 to-destructive/5 rounded-xl p-6 mb-4 group-hover:scale-105 transition-transform">
