...
const EthiopianHeader = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 bg-background/95 backdrop-blur-sm rounded-lg shadow-lg border border-border/20 my-2 mx-2 sm:mx-4 lg:mx-8">
